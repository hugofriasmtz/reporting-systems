...
<body>
    <div id="app">
        <div id="sidebar" class='active'>
            <div class="sidebar-wrapper active">
                ...
                <?php echo $structure->Navbar('Ventas'); ?>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Colaboradores de Ventas. 💰</h3>
                            <p class="text-subtitle text-muted">¿Quiénes integran el equipo de Ventas?</p>
                        </div>
                        <?php echo $structure->PagesTitle('Ventas'); ?>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Lista de Colaboradores de Ventas </h4>
                                    <div class="form-actions d-flex justify-content-end">
                                        <button type="button" class="btn icon icon-left btn-success open-modal" data-department="5" data-bs-toggle="modal" data-bs-target="#Add-collaborator">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                <?php echo $admin->TableUsersByDepartament(3, 5); ?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        // Actualizar dinámicamente el valor del departamento en el modal para Ventas
