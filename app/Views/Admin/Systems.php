...
<body>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Colaboradores de Sistemas. 💻</h3>
                            <p class="text-subtitle text-muted">¿Quiénes integran el equipo de sistemas?</p>
                        </div>
                        <?php echo $structure->PagesTitle('Sistemas'); ?>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Lista de Colaboradores de Sistemas </h4>
                                    <div class="form-actions d-flex justify-content-end">
                                        <button type="button" class="btn icon icon-left btn-success open-modal" data-department="1" data-bs-toggle="modal" data-bs-target="#Add-collaborator">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                <?php echo $admin->TableUsersByDepartament(3, 1); ?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        // Actualizar dinámicamente el valor del departamento en el modal para Sistemas
